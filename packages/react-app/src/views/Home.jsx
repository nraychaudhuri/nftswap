...
import { getNFTs } from "../libs/NFTLoader";
...
function Home({ mainnetProvider }) {
  ...
  const [addresses, setAddresses] = useState(hardcodedAddresses);
  ...
  useEffect(async () => {
    if (mainnetProvider) {
      ...
      const x = allNfts.filter(col => col.nfts.length > 0).map(col => {
        return { address: col.address, nft: col.nfts[0] }
      });
      console.log(">>> Collection ", x);
      setCollection(x);
    }
  }, [addresses, mainnetProvider]);
  return (
    <div>
              ...
              {collection &&
                collection.map((col, index) => (
                  <Card
                    ...
                    cover={
                      col.nft.image_data ? <svg id="src" xmlns="http://www.w3.org/2000/svg" dangerouslySetInnerHTML={createSvg(col.nft.image_data)} />
                        : <Image
                          preview={false}
                          src={col.nft.image || "error"}
                    ...
                    key={index}
                  >
                    <Meta title={col.nft.name} description={"Collection of " + col.address} />
                  </Card>
                  // <Card
                  //   hoverable
                  //   actions={[
                  ...
                  //   cover={
                  //     nft.image_data ? <svg id="src" xmlns="http://www.w3.org/2000/svg" dangerouslySetInnerHTML={createSvg(nft.image_data)} />
                  //       : <Image
                  //         preview={false}
                  //         src={nft.image || "error"}
                  //         fallback="data:image/png;base64,"
