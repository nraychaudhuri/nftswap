...
function NFTList({ data: NFTBalances, error }) {
          ...
          {NFTBalances?.result &&
            NFTBalances.result.map((nft, index) => (
              <Card
                ...
                cover={
                  nft?.metadata?.image_data ? <svg id="src" xmlns="http://www.w3.org/2000/svg" dangerouslySetInnerHTML={createSvg(nft.metadata.image_data)} />
                    : <Image
                      preview={false}
                      src={nft?.image || "error"}
